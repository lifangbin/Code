...
function setMILDataEditModal() {
    ...
    var fldAccEditable = ["", "", "disabled", "disabled", "readonly", "readonly", "readonly", "readonly", "readonly", "readonly", "readonly", "disabled", "", "readonly", "", "", "", "", "", "", "readonly", "disabled", "", "", ""]
    setAllTravelDataEditModal(tr, fldEditID, fldID, fldAccEditable);
...
function formatMIL(tr) {
    ...
    var fldID = ["idMILSNo",  "idMILExRate", "idMILType",  "idMILLCAmt", "idMILTransportation",  "idMILGSTCodeDisplay", "idMILDate", "idMILTaxableAmt", "idMILFrom", "idMILGSTAmt", "idMILTo", "idMILCostCenterDisplay", "idMILMileageStart", "idMILKmsMileageRate", "idMILGLCode", "idMILMileageEnd", "idMILClaimAmt", "idMILChargeToFactory", "idMILDistanceTravelled", "idMILClaimCurr", "idMILReceiptNo", "idMILExpDesc"]
    var fldLabel = ["S.#",  "Ex. Rate", "Expense Type",  "LC Amt", "Trans. Mode",  "GST Code", "Date",  "Taxable Amt", "Place From",  "GST Amt", "Place To",  "Cost Center", "Mileage Start", "Mileage Rate", "GL Code", "Mileage End", "FC Amt", "Charge to Fact.", "Dist. Travelled", "Curr.", "Receipt #", "Description"]
    var fldClass = ["",  "amount", "",  "amount", "",  "", "", "amount", "", "amount", "",  "", "amount", "amount", "", "amount", "amount", "", "amount", "", "", ""];
    strRowData = formatTravelFields(tr, fldLabel, fldID, fldClass, false);
    return strRowData;
}
...
function formatTSP(tr) {
    ...
    //var fldClass = ["", "amount", "", "", "amount", "", "", "", "", "", "amount", "", "", "amount", "", "", "", "", "amount", "", "", "", "", "", ""];
    //var fldClass = ["", "amount", "", "", "amount", "", "", "", "amount", "", "amount", "", "", "amount", "", "", "", "", "amount", "", "", "", "", "", ""];
    var fldLabel = ["S.#", "Exch. Rate", "Receipt Check?", "Expense Type", "LC Amt", "Date", "GST Code", "Receipt #", "Mode", "Taxable Amt", "Vendor #", "From", "GST Amt", "Invoice #", "To", "Cost Center", "BRN #", "FC Amt", "GL Code", "Curr.", "Charge To Fact.", "", "Description"];
    var fldID = ["idTSPSno", "idTSPExchRate", "idTSPReceiptcheck", "idTSPExpenseTypes", "idTSPLCAmt", "idTSPDate", "idTSPGSTCodeDisplay", "idTSPReceipt", "idTSPMode", "idTSPTaxableAmt", "idTSPVendor", "idTSPFrom", "idTSPGSTAmt", "idTSPInvoice", "idTSPTo", "idTSPCostCenterDisplay", "idTSPBRN", "idTSPFCAmt", "idTSPGlCode", "idTSPCurrency", "idTSPChargeToFactory", "", "idTSPDescription"];
    var fldWidth = ["15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15", "15"];
    var fldClass = ["", "amount", "", "", "amount", "", "", "amount", "", "amount", "", "", "amount", "", "", "", "", "amount", "", "", "", "", ""];
    strRowData = formatTravelFields(tr, fldLabel, fldID, fldClass, false);
    return strRowData;
}
